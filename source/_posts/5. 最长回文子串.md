...
找到字符串中最长的回文子串，提供了「动态规划』问题的思考路径
...
这道题上次做还是2017年8月1日，今天重刷感觉还是没吃透，下面的方法和思路借鉴自牛人的题解，写的非常漂亮，比官方题解还好，这是他的博客推荐多学习一个：https://liweiwei1419.gitee.io/leetcode-algo/#indexCard
...
public class Solution {
    ...
    public String longestPalindrome(String s) {
        ...
        //注意开始位置，只需要填这张表格对角线以上的部分，而且扫描的顺序要满足「无后效性」
        for (int j = 1; j < len; j++) {
            for (int i = 0; i < j; i++) {
...
写完代码以后，可以纸上写下代码运行的流程，以字符串 `'babad'` 为例：
 ...
 ['babad'](https://pic.leetcode-cn.com/b95575c883a4fc025e4e8816d4db1f35579d5bd945bfd9128154f882406bfce7-image.png)
...
**说明：表格中的数字表示「填表顺序」，从 1 开始**。表格外的箭头和数字也表示「填表顺序」，与表格中的数字含义一致。
 ...
 [错误的填表顺序](https://pic.leetcode-cn.com/4a24bbe4e55421f4f7d199b14e961eff792146092dd9a0c18cf06c824728407c-image.png)


 [正确的填表顺序](https://pic.leetcode-cn.com/7e9d1f1dbe2095b0609233faa03b224ab32adf832515de1ce15b496f2cbdf0ab-image.png)
...
【2】https://liweiwei1419.gitee.io/leetcode-algo/#indexCard
